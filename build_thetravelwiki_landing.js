...
<head>
    ...
    <title>شركة الإدارة الفندقية الأمريكية | الحل المباشر لبناء مواقع الفنادق بدون عمولات</title>
    <!-- Tailwind CSS v4 CDN -->
    <script src="https://cdn.jsdelivr.net/npm/@tailwindcss/browser@4"></script>
    <link href="https://fonts.googleapis.com/css2?family=Cairo:wght@300;400;600;700;800;900&display=swap" rel="stylesheet">
    <style>
        body { font-family: 'Cairo', sans-serif; }
        .glass-card { background: rgba(15, 23, 42, 0.85); backdrop-filter: blur(12px); border: 1px solid rgba(217, 119, 6, 0.3); }
...
<body class="bg-slate-950 text-slate-100 min-h-screen selection:bg-amber-500 selection:text-slate-950">
    ...
    <div class="bg-gradient-to-r from-amber-600 via-amber-500 to-amber-600 text-slate-950 text-xs md:text-sm font-black py-2 px-4 text-center shadow-lg flex items-center justify-center gap-2">
        <span class="bg-slate-950 text-amber-400 text-xs px-2.5 py-0.5 rounded-full">عرض خاص لفنادق مصر والجيزة</span>
        <span>وفر 35% من عمولات Booking.com واحصل على موقعك المباشر بـ 0% عمولة!</span>
    </div>
    ...
    <header class="border-b border-slate-800/80 bg-slate-950/90 sticky top-0 z-50 backdrop-blur-md">
        <div class="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-xl bg-gold-gradient flex items-center justify-center font-black text-slate-950 text-xl shadow-lg">
                    US
                </div>
                <div>
                    <h1 class="font-black text-white text-base md:text-lg leading-none">الإدارة الفندقية الأمريكية</h1>
                    <span class="text-xs text-amber-400 font-semibold">American Hotel Management Tech</span>
                </div>
            </div>
            
            <div class="flex items-center gap-3">
                <a href="https://wa.me/201222600296" target="_blank" class="hidden sm:flex bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs md:text-sm py-2 px-4 rounded-xl transition items-center gap-2 shadow-md">
                    <span>🇪🇬</span> واتساب مصري
                </a>
                <a href="https://wa.me/13074542064" target="_blank" class="bg-blue-700 hover:bg-blue-600 text-white font-bold text-xs md:text-sm py-2 px-4 rounded-xl transition flex items-center gap-2 shadow-md">
    ...
    <section class="relative py-16 md:py-24 px-4 overflow-hidden border-b border-slate-800/60">
        ...
        <div class="max-w-5xl mx-auto text-center">
            <div class="inline-flex items-center gap-2 bg-slate-900 border border-amber-500/40 text-amber-400 text-xs md:text-sm font-bold px-4 py-1.5 rounded-full mb-6 shadow-inner">
                <span>⭐</span> الحل الذكي والنهائي لملّاك ومديري الفنادق
            </div>

            <h2 class="text-3xl sm:text-5xl md:text-6xl font-black text-white mb-6 leading-tight">
                وقف نزيف العمولات الباهظة <br>
                <span class="gold-gradient-text">واحصل على حجوزات فندقك بـ 0% عمولة!</span>
            </h2>

            <p class="text-slate-300 text-base md:text-xl max-w-3xl mx-auto font-light leading-relaxed mb-8">
                نصمّم وننفّذ لفندقك موقع ويب فاخر بنظام حجز مباشر متطور، يتيح للنزلاء الحجز والدفع الإلكتروني المباشر بدون أي وسطاء، لتبقى كافة أرباحك الصافية لك وحدك!
            </p>

            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <a href="https://wa.me/201222600296?text=مرحباً،%20أرغب%20في%20استشارة%20مجانية%20لبناء%20موقع%20الحجز%20المباشر%20لفندقي" target="_blank" class="w-full sm:w-auto bg-emerald-600 hover:bg-emerald-500 text-white font-black text-base py-4 px-8 rounded-2xl transition shadow-xl flex items-center justify-center gap-3">
                    <span>💬</span> احصل على استشارة مجانية الآن
                </a>
                <a href="#portfolio" class="w-full sm:w-auto bg-slate-900 hover:bg-slate-800 border border-slate-700 text-slate-200 font-bold text-base py-4 px-8 rounded-2xl transition flex items-center justify-center gap-2">
                    <span>🔍</span> استعرض معرض أعمالنا الحية
                </a>
            </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto mt-14 pt-10 border-t border-slate-800/80">
                <div class="p-4 rounded-xl bg-slate-900/60 border border-slate-800">
                    <div class="text-2xl md:text-3xl font-black text-amber-400">0%</div>
                    <div class="text-xs text-slate-400 font-semibold mt-1">عمولة على الحجوزات المباشرة</div>
                </div>
                <div class="p-4 rounded-xl bg-slate-900/60 border border-slate-800">
                    <div class="text-2xl md:text-3xl font-black text-emerald-400">حتى 35%</div>
                    <div class="text-xs text-slate-400 font-semibold mt-1">وفورات مالية في أرباحك</div>
                </div>
                <div class="p-4 rounded-xl bg-slate-900/60 border border-slate-800">
                    <div class="text-2xl md:text-3xl font-black text-blue-400">100%</div>
                    <div class="text-xs text-slate-400 font-semibold mt-1">تحكم كامل في الأسعار والغرف</div>
                </div>
                <div class="p-4 rounded-xl bg-slate-900/60 border border-slate-800">
                    <div class="text-2xl md:text-3xl font-black text-purple-400">24 / 7</div>
                    <div class="text-xs text-slate-400 font-semibold mt-1">دعم وتدريب فني وتشغيلي</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 md:py-24 px-4 border-b border-slate-800/60">
        <div class="max-w-6xl mx-auto">
            <div class="text-center mb-12">
                <h3 class="text-3xl md:text-4xl font-black text-white">خدماتنا الشاملة لتطوير وتشغيل الفنادق</h3>
                <p class="text-slate-400 text-sm md:text-base mt-2">نقدم حلولاً متكاملة ترتقي بمستوى فندقك وتزيد من أرباحك الصافية</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                
                <div class="bg-slate-900/80 border border-slate-800 hover:border-amber-500/50 p-6 rounded-2xl transition">
                    ...
                    <h4 class="text-xl font-bold text-white mb-2">موقع حجز مباشر بدون عمولة</h4>
                    <p class="text-slate-400 text-sm leading-relaxed">تصميم موقع فندقي تفاعلي متعدد اللغات والعملات مزود بنظام حجز وتأكيد آلي بالفيزا.</p>
                </div>
                ...
                <div class="bg-slate-900/80 border border-slate-800 hover:border-amber-500/50 p-6 rounded-2xl transition">
                    ...
                    <h4 class="text-xl font-bold text-white mb-2">توفير عمالة واستاف فوري</h4>
                    <p class="text-slate-400 text-sm leading-relaxed">سد عجز العمالة فوراً بتوفير طاقم استقبال، إشراف داخلي، وإدارة مدربة ومحترفة.</p>
                </div>
                ...
                <div class="bg-slate-900/80 border border-slate-800 hover:border-amber-500/50 p-6 rounded-2xl transition">
                    ...
                    <p class="text-slate-400 text-sm leading-relaxed">رفع كفاءة طاقم الضيافة لتطبيق أعلى المعايير الفندقية العالمية لرفع تقييمات الفندق.</p>
                </div>
    ...
    <footer class="py-16 px-4 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 border-t border-slate-800">
        <div class="max-w-4xl mx-auto text-center">
            <h3 class="text-3xl md:text-4xl font-black text-white mb-4">
                هل أنت جاهز لوقف استنزاف العمولات وبدء الحجز المباشر؟
            </h3>
            <p class="text-slate-300 text-base md:text-lg mb-8 max-w-xl mx-auto font-light">
                تواصل مع فريق الإدارة الفندقية الأمريكية الآن واحصل على استشارة مجانية ومعاينة خاصة لموقع فندقك.
            </p>
            ...
            <div class="mt-12 pt-8 border-t border-slate-800/80 text-xs text-slate-500">
                جميع الحقوق محفوظة © 2026 شركة الإدارة الفندقية الأمريكية | thetravelwiki.blog
            </div>
        </div>
    </footer>
...
console.log('✅ Created Landing Page at:', path.join(landingDir, 'index.html'));

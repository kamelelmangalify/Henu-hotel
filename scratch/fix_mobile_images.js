...
const responsiveHomeHtml = `<!-- wp:html -->
...
/* ========================================================
   MOBILE RESPONSIVE RULES (PHONES & TABLETS)
   ======================================================== */
...
@media (max-width: 768px) {
  ...
  .btn-henu-gold, .btn-henu-outline {
    width: 100% !important;
...
<!-- HERO SECTION -->
<div class="henu-hero-wrap" style="background-image: url('${uploadsBase}/hero-pyramids-sunset.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat; min-height: 85vh; display: flex; align-items: center; justify-content: center; text-align: center; color: #FFFFFF; padding: 70px 20px; position: relative;">
  <div class="henu-hero-card" style="max-width: 900px; width: 100%; background: rgba(7, 19, 32, 0.45); padding: 36px 28px; border-radius: 16px; backdrop-filter: blur(6px); border: 1px solid rgba(201, 135, 58, 0.4); box-shadow: 0 12px 40px rgba(0,0,0,0.4);">
    <span class="henu-badge" style="background: var(--clr-gold); color: #FFFFFF; font-size: 0.85rem; padding: 6px 20px;">★ Pyramids View Boutique Hotel · Giza</span>
    <h1 style="font-family: var(--font-cinzel); font-size: clamp(2.1rem, 5vw, 3.8rem); font-weight: 900; line-height: 1.2; margin: 16px 0; color: #FFFFFF; text-shadow: 0 3px 15px rgba(0,0,0,0.8);">
      Where Ancient Wonders Meet <span style="color: var(--clr-gold-bright);">Modern Comfort</span>
    </h1>
    <p style="font-size: 1.18rem; font-weight: 500; color: #FFFFFF; max-width: 720px; margin: 0 auto 28px; line-height: 1.6; text-shadow: 0 2px 10px rgba(0,0,0,0.85);">
    ...
    <div style="display: flex; gap: 14px; justify-content: center; flex-wrap: wrap;">
      <a href="/contact#booking" class="btn-henu-gold" style="font-size: 1rem; padding: 14px 30px;">📅 Instant WhatsApp Booking</a>
      <a href="/accommodation" class="btn-henu-outline" style="font-size: 1rem; padding: 14px 26px;">🛏️ View Rooms from $12</a>
    </div>
  </div>
</div>

<!-- QUICK BOOKING BAR -->
<div style="background: var(--clr-nile); padding: 22px 20px; border-top: 3px solid var(--clr-gold);">
  <div class="henu-container henu-quick-booking" style="display: flex; gap: 16px; align-items: center; justify-content: space-between; flex-wrap: wrap;">
    <div style="color: #FFFFFF;">
      <div style="font-size: 0.78rem; color: var(--clr-gold-light); font-weight: 700; text-transform: uppercase;">Direct Booking WhatsApp Only</div>
      <div style="font-size: 1.35rem; font-weight: 800; font-family: var(--font-cinzel);">+20 100 092 5827</div>
    </div>
    <div style="color: #FFFFFF;">
      <div style="font-size: 0.78rem; color: var(--clr-sand); font-weight: 700; text-transform: uppercase;">Customer Service & Calls</div>
      <div style="font-size: 1.15rem; font-weight: 800; font-family: var(--font-cinzel);">+20 112 345 6777</div>
    </div>
    ...
    <div class="henu-grid-2">
      <div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 14px; margin-bottom: 26px;">
          <div style="background: #FFFFFF; padding: 16px; border-radius: 8px; border: 1px solid var(--clr-sand-dark); box-shadow: 0 2px 8px rgba(0,0,0,0.03);">
            <div style="font-size: 1.45rem; color: var(--clr-gold); font-weight: 800; font-family: var(--font-cinzel);">2 Min</div>
            <div style="font-size: 0.82rem; color: var(--clr-gray); font-weight: 600;">Walk to Sphinx Gate</div>
          </div>
          <div style="background: #FFFFFF; padding: 16px; border-radius: 8px; border: 1px solid var(--clr-sand-dark); box-shadow: 0 2px 8px rgba(0,0,0,0.03);">
            <div style="font-size: 1.45rem; color: var(--clr-gold); font-weight: 800; font-family: var(--font-cinzel);">$12+</div>
            <div style="font-size: 0.82rem; color: var(--clr-gray); font-weight: 600;">Best Direct Room Rates</div>
          </div>
        </div>
      ...
      <div class="henu-feature-img">
        <img src="${uploadsBase}/pyramids-terrace-night.jpg" alt="HENU Pyramids View">
      </div>
    </div>
  </div>
</div>
    ...
    <div class="henu-grid-3" style="text-align: left;">
      ...
      <div class="henu-card">
        ...
        <div class="henu-card-body">
          <div>
            <h3 style="font-family: var(--font-cinzel); font-size: 1.25rem; color: var(--clr-nile); margin-bottom: 6px;">Single Cozy Room</h3>
      ...
      <div class="henu-card">
        ...
        <div class="henu-card-body">
          <div>
            <h3 style="font-family: var(--font-cinzel); font-size: 1.25rem; color: var(--clr-nile); margin-bottom: 6px;">Double / Twin Room</h3>
      ...
      <div class="henu-card" style="border: 2px solid var(--clr-gold);">
        ...
        <div class="henu-card-body">
          <div>
            <h3 style="font-family: var(--font-cinzel); font-size: 1.25rem; color: var(--clr-nile); margin-bottom: 6px;">King Suite Pyramids View</h3>
...
<div class="henu-section" style="background: linear-gradient(135deg, #071320 0%, #0F2338 100%); color: #FFFFFF;">
  <div class="henu-container">
    <div class="henu-grid-2">
      ...
      <!-- Responsive Image Container -->
      <div class="henu-feature-img">
        <img src="${uploadsBase}/hero-pyramids-sunset.jpg" alt="Aisha Roof Sunset View">
      </div>
    </div>
  </div>
</div>
...
const localPath = 'd:/Henu/scratch/pages/home_responsive.html';
fs.writeFileSync(localPath, responsiveHomeHtml, 'utf8');

const conn = new Client();
conn.on('ready', () => {
  console.log('SSH Connected. Uploading responsive Home page...');
  conn.sftp((err, sftp) => {
    if (err) throw err;

    sftp.fastPut(localPath, 'domains/henuhotel.com/public_html/p_home_responsive.html', (err) => {
      if (err) throw err;

      const cmd = `
        cd ~/domains/henuhotel.com/public_html
        HOME_ID=$(wp post list --post_type=page --name=home --field=ID)
        wp post update $HOME_ID p_home_responsive.html
        rm -f p_home_responsive.html

        # Purge LiteSpeed Cache
        wp litespeed-purge all 2>/dev/null || true
        echo "=== MOBILE RESPONSIVENESS APPLIED SUCCESSFULLY ==="
      `;

...
const pagesDir = 'd:/Henu/scratch/pages';
...
fs.writeFileSync(path.join(pagesDir, 'home.html'), homeHtml, 'utf8');

// Write other pages
fs.writeFileSync(path.join(pagesDir, 'accommodation.html'), `<!-- wp:html -->
${globalStyles}
<div class="henu-section" style="background: var(--clr-ivory); padding-top: 40px;">
  <div class="henu-container" style="text-align: center;">
    ...
    <div class="henu-grid-3" style="text-align: left;">
      <div class="henu-card">
        <div class="henu-card-img"><img src="${uploadsBase}/room-single.jpg" alt="Single Standard"><div class="henu-card-price">$12 / Night</div></div>
        <div class="henu-card-body">
      ...
      <div class="henu-card">
        <div class="henu-card-img"><img src="${uploadsBase}/room-window.jpg" alt="Single Window"><div class="henu-card-price">$15 / Night</div></div>
        <div class="henu-card-body">
      ...
      <div class="henu-card">
        <div class="henu-card-img"><img src="${uploadsBase}/room-double-balcony.jpg" alt="Single Balcony"><div class="henu-card-price">$20 / Night</div></div>
        <div class="henu-card-body">
      ...
      <div class="henu-card">
        <div class="henu-card-img"><img src="${uploadsBase}/room-double.jpg" alt="Double Standard"><div class="henu-card-price">$18 / Night</div></div>
        <div class="henu-card-body">
      ...
      <div class="henu-card">
        <div class="henu-card-img"><img src="${uploadsBase}/room-deluxe-pharaonic.jpg" alt="Double Window"><div class="henu-card-price">$22 / Night</div></div>
        <div class="henu-card-body">
      ...
      <div class="henu-card">
        <div class="henu-card-img"><img src="${uploadsBase}/room-double-balcony.jpg" alt="Double Balcony"><div class="henu-card-price">$25 / Night</div></div>
        <div class="henu-card-body">
      ...
      <div class="henu-card">
        <div class="henu-card-img"><img src="${uploadsBase}/room-triple.jpg" alt="Triple Standard"><div class="henu-card-price">$25 / Night</div></div>
        <div class="henu-card-body">
          <h3 style="font-family: var(--font-cinzel); font-size: 1.25rem; color: var(--clr-nile);">Triple Family Standard</h3>
          <p style="font-size: 0.85rem; color: var(--clr-gray); margin-bottom: 12px;">3 comfortable single beds or 1 double + 1 single. Ideal for families.</p>
      ...
      <div class="henu-card">
        <div class="henu-card-img"><img src="${uploadsBase}/room-triple-window.jpg" alt="Triple Window"><div class="henu-card-price">$30 / Night</div></div>
        <div class="henu-card-body">
      ...
      <div class="henu-card" style="border: 2px solid var(--clr-gold);">
        <div class="henu-card-img"><img src="${uploadsBase}/room-suite.jpg" alt="Royal King Suite"><div class="henu-card-price" style="background: var(--clr-gold); color: #FFFFFF;">$45 / Night</div></div>
        <div class="henu-card-body">
...
fs.writeFileSync(path.join(pagesDir, 'experiences.html'), `<!-- wp:html -->
${globalStyles}
<div class="henu-section" style="background: var(--clr-ivory); padding-top: 40px;">
  <div class="henu-container" style="text-align: center;">
    ...
    <div class="henu-grid-3" style="text-align: left;">
      <div class="henu-card">
        <div class="henu-card-img"><img src="${uploadsBase}/hero-pyramids-sunset.jpg" alt="Pyramids Tour"></div>
        <div class="henu-card-body">
      ...
      <div class="henu-card">
        <div class="henu-card-img"><img src="${uploadsBase}/pyramids-terrace-night.jpg" alt="Sound & Light"></div>
        <div class="henu-card-body">
      ...
      <div class="henu-card">
        <div class="henu-card-img"><img src="${uploadsBase}/hero-pyramids-night.jpg" alt="Airport Pickup"></div>
        <div class="henu-card-body">
...
fs.writeFileSync(path.join(pagesDir, 'b2b.html'), `<!-- wp:html -->
${globalStyles}
<div class="henu-section" style="background: var(--clr-ivory); padding-top: 40px;">
  <div class="henu-container">
    ...
    <div class="henu-grid-2">
      <div>
        ...
        <div style="background: #FFFFFF; padding: 20px; border-radius: var(--radius); border: 1px solid var(--clr-sand-dark); margin-bottom: 16px;">
          ...
          <div style="font-size: 1.15rem; font-weight: 800; color: var(--clr-gold); font-family: var(--font-cinzel);"><a href="mailto:info@henuhotel.com" style="color: var(--clr-gold); text-decoration: none;">info@henuhotel.com</a></div>
          <div style="font-size: 0.85rem; color: var(--clr-gray); margin-top: 10px;">Corporate Hotline / Calls & WhatsApp:</div>
          <div style="font-size: 1.15rem; font-weight: 800; color: var(--clr-nile); font-family: var(--font-cinzel);"><a href="tel:+201123456777" style="color: var(--clr-nile); text-decoration: none;">+20 112 345 6777</a></div>
        </div>
      </div>
...
fs.writeFileSync(path.join(pagesDir, 'careers.html'), `<!-- wp:html -->
${globalStyles}
<div class="henu-section" style="background: var(--clr-ivory); padding-top: 40px;">
  <div class="henu-container">
    <div style="text-align: center; margin-bottom: 40px;">
    ...
    <div class="henu-grid-2">
      ...
      <div style="background: #FFFFFF; padding: 30px; border-radius: var(--radius); border: 1px solid var(--clr-sand-dark); box-shadow: var(--shadow);">
        ...
        <form action="mailto:info@henuhotel.com" method="post" enctype="text/plain" style="display: flex; flex-direction: column; gap: 12px;">
          ...
          <button type="submit" class="btn-henu-gold" style="width: 100%; justify-content: center;">Submit Application to info@henuhotel.com</button>
        </form>
      </div>
    </div>
  </div>
...
fs.writeFileSync(path.join(pagesDir, 'contact.html'), `<!-- wp:html -->
${globalStyles}
    ...
    <div class="henu-grid-2">
      ...
      <div style="background: #FFFFFF; padding: 32px; border-radius: var(--radius); border: 2px solid var(--clr-gold); box-shadow: var(--shadow);">
        ...
        <p style="font-size: 0.88rem; color: var(--clr-gray); margin-bottom: 20px;">
          Direct Booking WhatsApp Hotline: <strong>01000925827</strong> (+20 100 092 5827)
        </p>
...
console.log('All page HTML files generated locally in:', pagesDir);

// Upload and Import via WP-CLI
const conn = new Client();
conn.on('ready', () => {
  console.log('SSH Connected. Uploading pages...');
  conn.sftp((err, sftp) => {
    if (err) throw err;
    ...
    async function uploadAll() {
      const remoteDir = 'domains/henuhotel.com/public_html';
      await put(path.join(pagesDir, 'home.html'), `${remoteDir}/p_home.html`);
      await put(path.join(pagesDir, 'accommodation.html'), `${remoteDir}/p_acc.html`);
      await put(path.join(pagesDir, 'experiences.html'), `${remoteDir}/p_exp.html`);
      await put(path.join(pagesDir, 'b2b.html'), `${remoteDir}/p_b2b.html`);
      await put(path.join(pagesDir, 'careers.html'), `${remoteDir}/p_car.html`);
      await put(path.join(pagesDir, 'contact.html'), `${remoteDir}/p_con.html`);
      console.log('Files uploaded. Running WP-CLI...');

      const cmd = `
        cd ~/domains/henuhotel.com/public_html

        # Delete any sample pages
        wp post delete $(wp post list --post_type=page --format=ids) --force 2>/dev/null

        # Create the 6 pages
        HOME_ID=$(wp post create p_home.html --post_type=page --post_title="Home" --post_name="home" --post_status="publish" --porcelain)
        ACC_ID=$(wp post create p_acc.html --post_type=page --post_title="Accommodation" --post_name="accommodation" --post_status="publish" --porcelain)
        EXP_ID=$(wp post create p_exp.html --post_type=page --post_title="Experiences" --post_name="experiences" --post_status="publish" --porcelain)
        B2B_ID=$(wp post create p_b2b.html --post_type=page --post_title="B2B Services" --post_name="b2b" --post_status="publish" --porcelain)
        CAR_ID=$(wp post create p_car.html --post_type=page --post_title="Careers" --post_name="careers" --post_status="publish" --porcelain)
        CON_ID=$(wp post create p_con.html --post_type=page --post_title="Contact & Booking" --post_name="contact" --post_status="publish" --porcelain)
        ...
        wp menu delete "Main Menu" 2>/dev/null
        MENU_ID=$(wp menu create "Main Menu" --porcelain)
        wp menu item add-post $MENU_ID $HOME_ID --title="Home"
        wp menu item add-post $MENU_ID $ACC_ID --title="Accommodation"
        wp menu item add-post $MENU_ID $EXP_ID --title="Experiences"
        wp menu item add-post $MENU_ID $B2B_ID --title="B2B Services"
        wp menu item add-post $MENU_ID $CAR_ID --title="Careers"
        wp menu item add-post $MENU_ID $CON_ID --title="Contact & Booking"

        # Assign menu to primary location in Kadence
        wp menu location assign $MENU_ID primary 2>/dev/null
        wp menu location assign $MENU_ID mobile 2>/dev/null

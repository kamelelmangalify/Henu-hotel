...
const cardDir = 'd:/Henu/business_cards';
const imgDir = path.join(cardDir, 'images');
...
// 1. Copy Logo
fs.copyFileSync('d:/Henu/03_Procurement_and_Orders/شعار_الفندق_عقود.jpg', path.join(imgDir, 'logo.jpg'));
...
N:Morsy;Mohamed;;Mr.;
FN:Mohamed Morsy
ORG:HENU Pyramids Hotel
TITLE:Chairman & CEO
TEL;TYPE=CELL,VOICE:+201003333388
EMAIL;TYPE=WORK,INTERNET:m.morsy@henuhotel.com
URL:https://henuhotel.com
ADR;TYPE=WORK:;;21 Gamal Abdel Nasser St., Nazlet El-Semman;Giza;;;Egypt
NOTE:HENU Pyramids Hotel - Luxury Pyramids View Hotel
END:VCARD`;

const qrPath = path.join(imgDir, 'qr_vcard.png');

async function buildCard() {
  await QRCode.toFile(qrPath, vCardData, {
    color: {
      dark: '#071320',
      light: '#FFFFFF'
    },
  ...
  console.log('vCard QR Code generated at:', qrPath);
...
<head>
  <meta charset="UTF-8">
  <title>Mohamed Morsy — Business Card | HENU Hotel Pyramids</title>
  ...
  <style>
    ...
    * {
    ...
    /* Subtle geometric gold accent borders */
    .card-en::before {
      content: '';
      position: absolute;
      top: 2.5mm;
...
<body>
  ...
  <div class="card-page card-en">
    ...
    <div class="top-row">
      <div class="hotel-brand">
        <img src="images/logo.jpg" alt="HENU Hotel Logo" class="logo-img">
        <div class="brand-text">
          <h3>HENU<span> HOTEL</span></h3>
          <p>Pyramids View · Giza</p>
        </div>
      </div>
      <div class="badge-star">★ Boutique Luxury</div>
    </div>

    <!-- Middle Row: Person Info + Contact & QR -->
      ...
      <div>
        ...
        <div class="contact-list">
          <div class="contact-item">
            ...
            <span>Mobile: <strong>+20 100 333 3388</strong></span>
          </div>
          <div class="contact-item">
            ...
            <span>Email: <strong>m.morsy@henuhotel.com</strong></span>
          </div>
          <div class="contact-item">
            ...
            <span>Web: <strong>henuhotel.com</strong></span>
          </div>
        </div>
      </div>
    ...
    <div class="bottom-strip">
      <span>📍 21 Gamal Abdel Nasser St., Nazlet El-Semman, Giza, Egypt</span>
      <span>Pyramids View</span>
    </div>
  </div>
  ...
  <div class="card-page card-ar">
    ...
    <div class="top-row">
      <div class="hotel-brand-ar">
        <img src="images/logo.jpg" alt="شعار فندق هينو" class="logo-img">
        <div class="brand-text-ar">
          <h3>فندق <span>هينو</span> الأهرامات</h3>
          <p>إطلالة مباشرة على الأهرامات وأبو الهول</p>
        </div>
      </div>
      <div class="badge-star" style="background: rgba(201,135,58,0.15); color: var(--clr-gold); font-family: var(--font-cairo); font-size: 5pt;">ضيافة ملكية فاخرة</div>
    </div>
      ...
      <div>
        ...
        <div class="contact-list">
          <div class="contact-item-ar">
            <span class="icon"><svg width="10" height="10" viewBox="0 0 24 24" fill="currentColor"><path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/></svg></span>
            <span>موبايل: <strong>01003333388</strong> (20+)</span>
          </div>
          <div class="contact-item-ar">
            <span class="icon"><svg width="10" height="10" viewBox="0 0 24 24" fill="currentColor"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/></svg></span>
            <span>البريد: <strong>m.morsy@henuhotel.com</strong></span>
          </div>
          <div class="contact-item-ar">
            <span class="icon"><svg width="10" height="10" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg></span>
            <span>الموقع: <strong>henuhotel.com</strong></span>
          </div>
        </div>
      </div>
    ...
    <div class="bottom-strip-ar">
      <span>📍 21 شارع جمال عبد الناصر، نزلة السمان، الهرم، الجيزة</span>
      <span>Aisha Rooftop Lounge</span>
    </div>
  </div>
  ...
  const htmlPath = path.join(cardDir, 'card.html');
  fs.writeFileSync(htmlPath, htmlContent, 'utf8');
  console.log('Business Card HTML generated at:', htmlPath);

  // 4. Compile to PDF with Headless Browser
  const chromePath = 'C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe';
  const edgePath = 'C:\\Program Files (x86)\\Microsoft\\Edge\\Application\\msedge.exe';
  const browser = fs.existsSync(chromePath) ? chromePath : edgePath;

  const tempPdf = 'd:/Henu/scratch/card_output.pdf';
  const finalPdf = path.join(cardDir, 'كارت_محمد_مرسي_رئيس_مجلس_الإدارة.pdf');

  const cmd = `"${browser}" --headless=new --disable-gpu --run-all-compositor-stages-before-draw --print-to-pdf="${tempPdf}" --no-pdf-header-footer "file:///${htmlPath}"`;
  
  console.log('Compiling Business Card PDF...');
  execSync(cmd, { stdio: 'inherit' });

  if (fs.existsSync(tempPdf)) {
    fs.copyFileSync(tempPdf, finalPdf);
    console.log('Business Card PDF created successfully at:', finalPdf);

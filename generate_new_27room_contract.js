...
// =========================================================
// 1. إنشاء ملف PDF الفاخر 100% RTL بالعناوين والبنود العشرين
// =========================================================
...
<head>
  <meta charset="UTF-8">
  <title>عقد إيجار بنسيون فندقي (27 غرفة) — المطعم الأرجنتيني 2 ونصر دسوقي</title>
  <style>
...
<body>
  ...
  <div class="party-box">
    ...
    المقيم في: شارع جمال عبد الناصر، نزلة السمان، الهرم، الجيزة، ويحمل بطاقة رقم قومي: <strong>27410100100942</strong>.
  </div>
  ...
  <div class="party-box tenant">
    ...
    ويمثلها رئيس مجلس الإدارة <strong>السيد / محمد ممدوح عبد الحميد مرسي</strong>، ويحمل بطاقة رقم قومي: <strong>28419000010459</strong>، الكائنة في: محل 2 الدور الأرضي، 159 شارع 26 يوليو، الزمالك، قصر النيل.
  </div>
    ...
    <table class="sig-table">
      <tr>
        <td class="sig-box">
          ...
          الاسم: نصر دسوقي عبد الحميد عبد الصمد<br><br>
          التوقيع: .......................................
        </td>
        <td style="width: 4%;"></td>
        <td class="sig-box">
          <strong style="color: #D97706; font-size: 12pt;">الطرف الثاني (المستأجر)</strong><br><br>
          الاسم: شركة المطعم الأرجنتيني 2 (عنها/ محمد ممدوح مرسي)<br><br>
          التوقيع: .......................................
        </td>
      </tr>
...
// =========================================================
// 2. إنشاء ملف Word (.docx) 100% RTL مطابق تماماً
// =========================================================
  ...
  const doc = new Document({
    sections: [{
      ...
      children: [
        ...
        createRtlParagraph("الطرف الأول (مؤجر): السيد / نصر دسوقي عبد الحميد عبد الصمد، المقيم في: شارع جمال عبد الناصر، نزلة السمان، الهرم، الجيزة، ويحمل بطاقة رقم: 27410100100942.", { size: 28 }),
        createRtlParagraph("الطرف الثاني (مستأجر): شركة / المطعم الأرجنتيني 2، ويمثلها رئيس مجلس الإدارة السيد / محمد ممدوح عبد الحميد مرسي، ويحمل بطاقة رقم: 28419000010459، الكائنة في: محل 2 الدور الأرضي، 159 شارع 26 يوليو، الزمالك، قصر النيل.", { size: 28 }),
...
<body>
  ...
  <div class="header">
    ...
    <div style="font-size: 9pt; color: #4a5568;">النسخة الشاملة المزودة بعقد الإيجار الرسمي الـ 20 بنداً للـ 27 غرفة — 2026م</div>
  </div>
  ...
  <div class="folder-card" style="border-right-color: #D9822B;">
    ...
    <ul>
      <li><span class="badge-pdf">PDF</span> <span class="badge-word">WORD</span> <strong>عقد_إيجار_البنسيون_الرسمي_المطعم_الأرجنتيني_27غرفة.pdf / docx:</strong> عقد الإيجار الرسمي المحدث (20 بنداً - 27 غرفة - 220,000 جـ - التأمين والمصعد والتصالح).</li>
...
async function main() {
  ...
  await generateWord();
  updateSitemap();
  console.log('\n✨ NEW 20-CLAUSE CONTRACT PDF & DOCX GENERATED SUCCESSFULLY!');
}
